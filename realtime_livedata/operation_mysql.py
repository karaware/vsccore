...
def insert_result():
    ...
    #s3ThumbnailUrl = "https://vsc-thumbnail.s3.ap-northeast-1.amazonaws.com/tomeru/20210905_2240_Rbs9w_aKBdg_thumbnail.jpg"
    #s3GraphUrl = "https://vsc-graph.s3.ap-northeast-1.amazonaws.com/tomeru/20210905_2248_Rbs9w_aKBdg_liveresult.png"
    ...
    s3ThumbnailUrl = "https://vsc-thumbnail.s3.ap-northeast-1.amazonaws.com/tomeru/" + operation_redis.get_thumbnail_img_name()
    s3GraphUrl = "https://vsc-graph.s3.ap-northeast-1.amazonaws.com/tomeru/" + operation_redis.get_graph_img_name()


    cur = conn.cursor()

    #sql = "INSERT INTO tomeru_result ( \
    sql = "INSERT INTO vscwebtomeru_resultmodel ( \
    videoId, \
    videoTitle, \
    startTime, \
    endTime, \
    ...
    #cur.execute("SELECT * FROM tomeru_result")
    cur.execute("SELECT * FROM vscwebtomeru_resultmodel")
